...
<script>
  ...
  rowsATransferir.forEach(function(r,i){
    ...
    var monLabel = '<span class="neto-mon">'+moneda+(r._arrastrado?' · quincena anterior':'')+'</span>';
    ...
    if(r.estado==='Abono') {
      novedades.push({nombre:r.empleado_nombre, nota:'Abono previo de $'+(r._totalAbonado||0).toLocaleString('es-CO')+' — este pago es el saldo restante', dedu:0});
    }
